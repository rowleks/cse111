...
def compute_molar_mass(symbol_quantity_list: list, periodic_table_dict):
...
def main():
    ...
    chemical_formula = input("Type a chemical formula: ").upper()
    mass_from_sample = float(input("Type the mass of the sample in grams: "))
    ...
    calculated_molar_mass = compute_molar_mass(parsed_formula, periodic_table)

    number_of_moles = mass_from_sample / calculated_molar_mass

    print()
    print(f"The molar mass of {formula_name}: {calculated_molar_mass:.5f} grams/mole")
