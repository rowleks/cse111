...
def test_pressure_loss_from_pipe():
    assert pressure_loss_from_pipe(0.048692, 0.00, 0.18, 1.75) == approx(
        0.000, abs=0.001
    )
...
def test_psi_from_kpa():
    assert psi_from_kpa(0.0) == approx(0.0, abs=0.001)
    assert psi_from_kpa(101.325) == approx(14.6959, abs=0.001)
    assert psi_from_kpa(200.0) == approx(29.0076, abs=0.001)
